...
const projects = [
  ...
  },
  {
    ...
    date: "2025",
    icon: Film,
    desc: "A front-end prototype for a media streaming platform. Built with React 19 and Vite 8 for fast builds and hot module replacement, styled using Tailwind CSS and Lucide React.",
    stack: ["React 19", "Vite 8", "Tailwind CSS", "Lucide React"],
    type: "visual",
